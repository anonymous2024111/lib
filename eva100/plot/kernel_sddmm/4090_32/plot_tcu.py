...
# flash_G_avg = [x * 0.8 for x in flash_G_avg]
...
# ax.legend()
# 显示图形
plt.savefig('/home/shijinliang/module/Libra-sc25/eva100/plot/kernel_sddmm/4090_32/4090_sddmm_tf32_32_tcu.png', dpi=800)
# 清空图形
plt.clf()