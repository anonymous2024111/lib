...
libra_road = 0
#统计128的数据
df1 = pd.read_csv('/home/shijinliang/module/Libra-sc25/eva100/plot/res_4090/filter_4090_spmm_fp16_result_128.csv')
df1['libra'] = df1[['1', '2', '3', '4', '5', '6', '7', '8','spmm_tcu', 'spmm_cuda']].min(axis=1)
df2 = pd.read_csv('/home/shijinliang/module/Libra/eva100/plot/kernel_spmm/4090_128/rode_spmm_f32_n128_0215.csv')

df_res = pd.merge(df1, df2, on='dataSet', how='inner')  # 使用内连接（inner join）
#tcgnn
df3 = pd.read_csv('/home/shijinliang/module/Libra/eva100/plot/res_4090/tcgnn_spmm_h100_128.csv')
df_res = pd.merge(df_res, df3, on='dataSet', how='inner')  # 使用内连接（inner join）
# 方图
df4 = pd.read_csv('/home/shijinliang/module/Libra/eva100/plot/res_4090/dtc_4090_128.csv')
...
for index, row in df_res.iterrows():
    ...
    dtc.append(round((row['dtc']/row['libra']),4))
    total+=1
