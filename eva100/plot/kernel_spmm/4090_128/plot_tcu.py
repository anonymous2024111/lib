...
for index, row in df_res.iterrows():
    ...
    # if (round((compute/row['libra_tf32'])*1e-6,4))>12000:
    #     continue
...
# 显示图形
plt.savefig('/home/shijinliang/module/Libra-sc25/eva100/plot/kernel_spmm/4090_128/4090_spmm_tf32_128_tcu.png', dpi=800)
# 清空图形
plt.clf()
