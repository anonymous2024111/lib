...
print("geo : ",stats.gmean(filtered_list) )
print("max : ",max(flash) )
flash_.append(round(stats.gmean(filtered_list),2) )
...
print("geo : ",stats.gmean(filtered_list) )
print("max : ",max(flash) )
flash_1.append(round(stats.gmean(filtered_list),2) )
...
text = '1\\textasciitilde1.5 & '
text += str(tcgnn_[1]) + '\% & '
text += str(dtc_[1]) + '\% & ' 
text += str(flash_[1]) + '\% & ' 
text += str(cusparse_[1]) + '\% & ' 
text += str(sputnik_[1]) + '\% & ' 
text += str(rode_[1]) + '\% & ' 
...
text = '1.5\\textasciitilde2 & '
text += str(tcgnn_[2]) + '\% & '
text += str(dtc_[2]) + '\% & ' 
text += str(flash_[2]) + '\% & ' 
text += str(cusparse_[2]) + '\% & ' 
text += str(sputnik_[2]) + '\% & ' 
text += str(rode_[2]) + '\% & ' 
