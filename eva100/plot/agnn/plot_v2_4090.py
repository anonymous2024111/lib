...
libra_fp16_128 = [32.4686, 39.0712, 10.231]
libra_tf32_128 = [69.104, 55.0199, 17.5087]
tcgnn_128 =[77.2733, 700, 700]
dgl_128 = [70.9528, 150.1713, 27.2276]
pyg_128 = [100000, 100000, 100000]
...
for data in dataset:
 ...
 #绘制Libra-FP16
    ...
    plt.savefig('/home/shijinliang/module/Libra/eva100/plot/agnn/4090-agnn-' + data +'.png', dpi=800)
    cur += 1
    # 清空图形
    plt.clf()
    
print("fp16:")
print(libra_fp16_speedup_128)
print("dgl ", stats.gmean(libra_fp16_speedup_128))
print("dl: ", max(libra_fp16_speedup_128))
print()
# #fp16 加速比
# print("fp16:")
