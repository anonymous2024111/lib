...
if __name__ == "__main__":
    ...
    #用于存储结果
    file_name = '/home/shijinliang/module/Libra/eva100/plot/ablation/format_NG/result/fp16_sgt.csv'
    head = ['dataSet', 'num_nodes', 'num_edges', 'spmm_tcu_sgt']
    # 写入数据到 CSV 文件ablation/format_NG/spmm_h100_fp16_test_sgt.py
    # with open(file_name, 'w', newline='') as csvfile:
    #     csv_writer = csv.writer(csvfile)
    #     csv_writer.writerow(head)

    #读取csv遍历每个数据集
    df = pd.read_csv('/home/shijinliang/module/Libra/eva100/plot/ablation/format_NG/result/data.csv')
