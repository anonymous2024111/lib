...
dataset = ['cbuckle', '2D_54019_highK', '2D_27628_bjtcai', 'Zd_Jac2','pkustk01']
dataset = ['SiO2', 'pkustk05', 'Ga3As3H12', 'Zd_Jac2','gupta2']
dataset = ['ex19', '2D_27628_bjtcai', '3D_28984_Tetra', 'gupta1','std1_Jac2']
df1 = pd.read_csv('/home/shijinliang/module/Libra/eva100/plot/res_4090/filter_4090_spmm_fp16_result_128.csv')
cur = 0
...
plt.savefig('/home/shijinliang/module/Libra/eva100/plot/ablation/preprocess_4090' +'.png', dpi=800)
