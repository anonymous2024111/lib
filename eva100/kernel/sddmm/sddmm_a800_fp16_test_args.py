...
if __name__ == "__main__":
    ...
    type = 0
    #用于存储结果
    file_name = '/home/shijinliang/module/Libra/res/a800/sddmm/fp16/filter_a800_sddmm_fp16_result_' + str(dimN) + '.csv'
    ...
    file_name_concat = '/home/shijinliang/module/Libra/res/a800/sddmm/fp16/a800_sddmm_fp16_result_concat_' + str(dimN) + '.csv'
