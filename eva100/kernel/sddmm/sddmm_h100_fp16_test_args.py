...
if __name__ == "__main__":
    ...
    type = 0
    #用于存储结果
    file_name = '/home/shijinliang/module/Libra-sc25/res/h100/sddmm/fp16/new_filter_h100_sddmm_fp16_result_new0221_' + str(dimN) + '.csv'
    ...
    #     df = pd.read_csv('/home/shijinliang/module/Libra/data_filter.csv')
    # else :
    #     df = pd.read_csv('/home/shijinliang/module/Libra/data_filter_256.csv')
    
    filter = pd.read_csv('/home/shijinliang/module/Libra-sc25/res/h100/sddmm/fp16/new_filter_h100_sddmm_fp16_result_new0220_32.csv')
    dataset_list = filter['dataSet'].tolist()

    for index, row in df.iterrows():
        if row.iloc[0] in dataset_list:
            continue
        res_temp = []
