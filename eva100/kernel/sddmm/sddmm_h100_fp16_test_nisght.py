...
if __name__ == "__main__":
    ...
    type = 0
    #用于存储结果
    file_name = '/home/shijinliang/module/Libra/res/h100/sddmm/fp16/new_filter_h100_sddmm_fp16_result_' + str(dimN) + '.csv'
    ...
    #读取csv遍历每个数据集
    df = pd.read_csv('/home/shijinliang/module/Libra/data_nsight.csv')
