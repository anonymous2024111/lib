...
if __name__ == "__main__":
    ...
    #用于存储结果
    file_name = '/home/shijinliang/module/Libra/res_gnn/h100/spmm/fp16/h100_spmm_fp16_result_' + str(dimN) + '.csv'
    ...
    dataset =[  'twitter', 'Reddit2', 'amazon', 'amazon0505','LastFM','twitter', 'MOOC','wiki']
    dataset =[   'LastFM','twitter', 'MOOC','wiki',
                'dd','IGB_small', 'reddit', 'blog', 'yeast']
    dataset = ['ogb', 'AmazonProducts', 'IGB_medium', 'DGraphFin']
    ...
    # file_name_concat = '/home/shijinliang/module/Libra/res_gnn/h100/spmm/fp16/h100_spmm_fp16_result_concat_' + str(dimN) + '.csv'
