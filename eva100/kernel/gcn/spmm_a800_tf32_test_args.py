...
if __name__ == "__main__":
    ...
    #用于存储结果
    file_name = '/home/shijinliang/module/Libra/res_gnn/a800/spmm/tf32/a800_spmm_tf32_result_' + str(dimN) + '.csv'
    ...
    for data in dataset:
        graph = np.load('./dgl_dataset/best/' + data +'.npz')
        num_nodes_ori = graph['num_nodes_ori']-0
    ...
    file_name_concat = '/home/shijinliang/module/Libra/res_gnn/a800/spmm/tf32/a800_spmm_tf32_result_concat_' + str(dimN) + '.csv'
