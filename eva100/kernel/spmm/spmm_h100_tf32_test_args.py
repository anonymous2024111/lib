...
if __name__ == "__main__":
    ...
    #用于存储结果
    file_name = '/home/shijinliang/module/Libra-sc25/res/h100/spmm/tf32/filter_h100_spmm_tf32_result_new2_0221_' + str(dimN) + '.csv'
    ...
    for index, row in df.iterrows():
        ...
        for dense in density:
            spmm = libra_csr_test_tcu_cuda(row.iloc[0], hidden, epoches, dense,partsize_t, partsize_c, shortsize, data_path, window, wide)
    ...
    # file_name_concat = '/home/shijinliang/module/Libra/res/h100/spmm/tf32/h100_spmm_tf32_result_concat_' + str(dimN) + '.csv'
