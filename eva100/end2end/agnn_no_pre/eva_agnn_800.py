...
if __name__ == "__main__":
    ...
    # layer = [6]
    hidden = [256]
    # dataset = ['artist', 'blog', 'ell',  'com-DBLP', 'Reddit2', 'amazon', 'amazon0505', 
    #               'dd', 'yelp', 'comamazon', 'roadNet-CA', 'roadNet-PA', 
    #               'roadNet-TX', 'yeast', 'DGraphFin']
    ...
    #DGL
    # filename = './eva100/end2end/agnn_no_pre/result/dgl-v1.csv'
    ...
    #MGCN-fp16
    # filename = './eva100/end2end/agnn_no_pre/result/mgcn16-v1-1.csv'
    # with open(filename, 'w') as file:
    #     file.write('H100 : \n')
    # for layer_num in layer:
    #     if layer_num == 6:
    ...
    # #MGCN-tf32   
    filename = './eva100/end2end/agnn_no_pre/result/mgcn32-v1-1.csv'
    # with open(filename, 'w') as file:
    #     file.write('H100 : \n')
    for layer_num in layer:
        if layer_num == 6:
    ...
    #TCGNN
    # filename = './eva100/end2end/agnn_no_pre/result/tcgnn-v1.csv'
    # with open(filename, 'w') as file:
    #     file.write('H100 : \n')
    # for layer_num in layer:
    #     if layer_num == 6:
    ...
    #PYG
    # filename = './eva100/end2end/agnn_no_pre/result/pyg-v1.csv'
    # with open(filename, 'w') as file:
    #     file.write('H100 : \n')
    # for layer_num in layer:
    #     if layer_num == 6:
