...
class MGCN_dataset_tcu_cuda(torch.nn.Module):
    ...
    def init_edges(self,density,  window, wide):
        ...
        self.duration = Libra6SpMM.block_fp16_tcu_cuda_bcrs(self.row_pointers, self.column_index, self.degrees, self.partsize_t, self.partsize_c, self.short_size, density, window, wide)
