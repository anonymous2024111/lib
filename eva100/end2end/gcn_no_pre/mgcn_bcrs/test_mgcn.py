...
from mgcn_bcrs.mdataset_fp16 import *
from mgcn_bcrs.mgcn_conv import *
from mgcn_bcrs.gcn_mgnn import *
from torch.optim import Adam
import time


def test_libra_tcu_cuda(data, epoches, layers, featuredim, hidden, classes,  density, partsize_t, partsize_c, window, wide):
    # 记录程序开始时间
