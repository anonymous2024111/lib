...
class MGATFunction(torch.autograd.Function):
    ...
    def backward(ctx, att_grad):
        ...
        '''
        #att_grad求a0梯度
        a0_tmp= MagicsphereGCN_cmake.forward_filter(inputInfo.row_pointers, inputInfo.column_index, att_grad, inputInfo.values_templete, X_prime, inputInfo.num_nodes, X_prime.size(1), inputInfo.num_nodes_ori)
        ...
        #att_grad求a1梯度
        a1_tmp= MagicsphereGCN_cmake.forward_filter(inputInfo.row_pointers, inputInfo.column_index, att_grad,inputInfo.values_templete, inputInfo.ones, inputInfo.num_nodes, inputInfo.ones.size(1), inputInfo.num_nodes_ori)
...
class MGATSpmm(torch.autograd.Function):
    ...
    def backward(ctx, X_prime_grad):
        ...
        #求X_prime_grad
        #d_X_prime= MagicsphereGCN_cmake.forward_filter(inputInfo.row_pointers, inputInfo.column_index, att_trans,inputInfo.values_templete, X_prime_grad, inputInfo.num_nodes, X_prime_grad.size(1), inputInfo.num_nodes_ori)
