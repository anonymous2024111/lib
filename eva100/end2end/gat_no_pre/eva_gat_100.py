...
if __name__ == "__main__":
    ...
    '''
    #DGL
    filename = './eva100/end2end/gat_no_pre/result/dgl-v2.csv'
    ...
    #MGCN-fp16
    filename = './eva100/end2end/gat_no_pre/result/mgcn16-v2.csv'
    with open(filename, 'w') as file:
        file.write('H100 : \n')
    for layer_num in layer:
        for hidden_num in hidden:
    ...
    #MGCN-tf32   
    filename = './eva100/end2end/gat_no_pre/result/mgcn32-v2.csv'
    with open(filename, 'w') as file:
        file.write('H100 : \n')
    for layer_num in layer:
        for hidden_num in hidden:
