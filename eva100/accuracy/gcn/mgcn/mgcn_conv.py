...
class MGCNFunction(torch.autograd.Function):
    ...
    def forward(ctx, X, weights, inputInfo):
        ...
        X_prime = MagicsphereGCN.forward(inputInfo.row_pointers, inputInfo.column_index, inputInfo.degrees, 
    ...
    def backward(ctx, d_output):
        ...
        d_input_prime = MagicsphereGCN.forward(inputInfo.row_pointers, inputInfo.column_index, inputInfo.degrees, 
