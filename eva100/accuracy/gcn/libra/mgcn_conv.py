...
class MGCNFunction(torch.autograd.Function):
    ...
    def forward(ctx, X, weights, inputInfo):
        ...
        X_prime = Libra3GCN.forward_tf32_v2(inputInfo.c_rowTensor,inputInfo.c_colTensor,inputInfo.c_valueTensor,
                                         inputInfo.t_rowTensor,inputInfo.t_colTensor,inputInfo.t_valueTensor, X_prime,
                                         inputInfo.num_nodes, inputInfo.x.size(1), inputInfo.num_nodes_ori)
        # X_prime = Libra3GCN.forward_tf32_v3(inputInfo.row_pointers, inputInfo.column_index, inputInfo.degrees, 
        #                        X_prime,inputInfo.tcu, inputInfo.num_nodes, X_prime.size(1), inputInfo.num_nodes_ori)
    ...
    def backward(ctx, d_output):
        ...
        d_input_prime = Libra3GCN.forward_tf32_v2(inputInfo.c_rowTensor,inputInfo.c_colTensor,inputInfo.c_valueTensor,
                                         inputInfo.t_rowTensor,inputInfo.t_colTensor,inputInfo.t_valueTensor, d_output,
                                         inputInfo.num_nodes, inputInfo.x.size(1), inputInfo.num_nodes_ori)
        # d_input_prime = LibraGCN.forward_tf32_v3(inputInfo.row_pointers, inputInfo.column_index, inputInfo.degrees, 
        #                        d_output, inputInfo.tcu, inputInfo.num_nodes, d_output.size(1), inputInfo.num_nodes_ori)
