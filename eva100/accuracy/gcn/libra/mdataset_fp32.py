...
class MGCN_dataset(torch.nn.Module):
    ...
    def init_edges(self):
        ...
        #bcsr
        self.c_rowTensor, self.c_colTensor, self.c_valueTensor, self.t_rowTensor, self.t_colTensor, self.t_valueTensor=Libra3Block.blockProcess16(self.row_pointers, self.column_index,self.dd)
        # self.row_pointers, self.column_index, self.degrees, self.tcu=LibraBlock.blockProcess16(self.row_pointers, self.column_index,dd)
        # self.row_pointers, self.column_index, self.degrees=MagicsphereBlock.blockProcess8_4(self.row_pointers, self.column_index,dd)
