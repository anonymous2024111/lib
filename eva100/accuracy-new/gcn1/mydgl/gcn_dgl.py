...
def train(g, features, labels, train_mask, val_mask, model,epoches):
    ...
    with open("/home/shijinliang/module/git-flashsprase-ae2/eva/accuracy/gcn/dgl-pubmed.txt", "w", encoding="utf-8") as file:
        file.write("")
    # training loop
    for epoch in range(epoches):
        ...
        with open("/home/shijinliang/module/git-flashsprase-ae2/eva/accuracy/gcn/dgl-pubmed.txt", "a", encoding="utf-8") as file:
            file.write(data + "\n")