...
#读取Flash-fp16
path= '/home/shijinliang/module/git-flashsprase-ae2/eva/accuracy/gcn/'
...
# 显示图形
plt.savefig('/home/shijinliang/module/git-flashsprase-ae2/eva/accuracy/gcn/gcn-cora1.png', dpi=800)
# 清空图形
plt.clf()