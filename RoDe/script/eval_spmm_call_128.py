...
#result path
file_name = project_dir + '/eva100/plot/kernel_spmm/h100_fp16_128/rode_spmm_f32_n128_0216.csv'
...
for index, row in df_res.iterrows():
    ...
    shell_command = project_dir + "/RoDe/build/eval/eval_spmm_f32_n128 " + "/public/home/shijinliang/Rode/data/" + row['dataSet'] + '/' + row['dataSet'] + ".mtx >> " + file_name
    print(row['dataSet'])
