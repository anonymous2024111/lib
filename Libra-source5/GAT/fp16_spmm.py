...
c_rowTensor, \
c_colTensor,\
c_atomicTensor = Libra5Block.block_tf32_tcu_cuda_binary_sddmm(row,col, 2, 4, 6, 8, 16)
...
result = LibraAGNN_new.forward_fp16(
...
nnz_c = c_colTensor_.shape[0]
total = row[-1]

# SpMM
result = LibraAGNN_new.forward_fp16_spmm(
t_rowNew_offsetTensor_, 
t_blockTensor_,
t_columnTensor_, 
t_window_rowTensor_,
