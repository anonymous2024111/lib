...
//tcu cuda
void spmm_forward_tf32_tcu_part_kernel(
    int * t_row_offset,
    int * t_blockNew_offset,
    float * t_value, 
    int * t_column, 
...
//cuda 长短行
void spmm_forward_tf32_cuda_kernel_split(
...
void spmm_forward_tf32_cuda_kernel_split_32(
...
//cuda 长短行 fp16
void spmm_forward_fp16_cuda_kernel_split(
...
void spmm_forward_fp16_cuda_kernel_split_32(
    ...
    const int mOri)
{
    ...
    // float * rhs_matrix_c = reinterpret_cast<float2 *>(rhs_matrix);
...
void spmm_forward_tf32_tcu_cuda_kernel_32(
    int * t_row_offset,
    int * t_blockNew_offset,
    float * t_value, 
    int * t_column, 
...
void spmm_forward_fp16_tcu_cuda_kernel_32(
    int * t_row_offset,
    int * t_blockNew_offset,
    half * t_value, 
    int * t_column, 
