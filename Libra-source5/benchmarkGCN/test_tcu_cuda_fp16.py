...
c_colTensor_short, \
c_valueTensor_short= Libra5Block.block_tf32_tcu_cuda_binary(row,col,dd, 2, 4, 2, 3, 8, 8)
...
# rhs_ = rhs.to(device)
rhs = rhs.half()
t_valueTensor = t_valueTensor.half()
c_valueTensor = c_valueTensor.half()
c_valueTensor_short = c_valueTensor_short.half()
result, spmm_ms_avg = Libra5BenchmarkGCN.forward_fp16_tcu_cuda(
t_rowNew_offsetTensor, 
t_blockTensor,
t_columnTensor, 
t_valueTensor, 
