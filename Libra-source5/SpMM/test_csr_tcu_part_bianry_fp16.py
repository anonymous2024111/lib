...
t_window_rowTensor, \
t_atomicTensor, \
t_binaryTensor  = Libra5Block.block_csr_binary_tcu_part(row,col,dd, 2, 8, 8)
...
result, spmm_ms_avg = Libra5BenchmarkGCN.forward_fp16_tcu_binary_part(
t_rowNew_offsetTensor, 
t_blockTensor,
t_columnTensor, 
t_valueTensor.half(), 
...
t_rowNew_offsetTensor.shape[0]-1,
rhs.size(1), 
rows, 
rows,
1)
# print(dd)
res = check(row,col,dd,rhs,rows)
print(result)
print(res)
